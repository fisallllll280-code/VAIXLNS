...
| Innovation | Family | Owner | State |
|---|---|---|---|
| VX deterministic runtime | Execution | VX | PARTIAL |
| Event + State + Ledger | Event / State | VX | PARTIAL |
...
| Proof Lease | Authorization | VX / Core | PARTIAL |
...
|---|---|---|---|
| Discovery | ASDE, Missing System Discovery Engine, Canonical Indexing Engine, Semantic Linking / Auto-Classification | NEXENT | SOURCE-ASSERTED / mixed evidence |
...
| Multi-Mind | Specialist Registry, Capability Routing, Dependency Coordination, Bounded Autonomy | NEXENT | IMPLEMENTEDIFIED |
| Verification Research | Contradiction Engine, Formal Proof Orchestrator, Cross-Runtime Equivalence, Proof-Carrying Architecture | NEXENT | SOURCE-ASSERTED / mixed evidence |
